...
namespace OnlineStore.UI.EasyConsole
{
    public abstract class Program
    {
        public static User User { get; set; }
        public static List<ProductDto> ProductBasket { get; } = new List<ProductDto>();
        ...
        protected Program(string title, bool breadcrumbHeader, User client)
        {
            User = client;
            Title = title;
